...
namespace RobotizeToolbox.Extensions
{
    public static class JscriptExecutor
    {
        ...
        public static bool IsElementOutViewport_1(RemoteWebDriver driver, string xpath)
        {
            ...
            //{
            //    var element = document.evaluate("//div[contains(@data-pagelet,'Feed')]//div[@aria-posinset='4']", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
            //    const rect = element.getBoundingClientRect();
