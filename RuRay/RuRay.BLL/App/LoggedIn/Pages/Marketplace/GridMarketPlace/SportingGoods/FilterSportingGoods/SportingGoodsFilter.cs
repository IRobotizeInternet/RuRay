...
{
    /// <summary>
    /// Defines the <see cref="SportingGoodsFilter" />.
    /// </summary>
    public class SportingGoodsFilter : BaseFilter, ISportingGoodsFilter, ISportingGoodsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SportingGoodsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="SportingGoodsCategory"/>.</param>
