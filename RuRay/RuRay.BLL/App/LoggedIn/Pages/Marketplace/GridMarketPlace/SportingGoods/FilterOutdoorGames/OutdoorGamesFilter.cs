...
{
    /// <summary>
    /// Defines the <see cref="OutdoorGamesFilter" />.
    /// </summary>
    public class OutdoorGamesFilter : BaseFilter, IOutdoorGamesFilter, IOutdoorGamesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutdoorGamesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="OutdoorGamesCategory"/>.</param>
