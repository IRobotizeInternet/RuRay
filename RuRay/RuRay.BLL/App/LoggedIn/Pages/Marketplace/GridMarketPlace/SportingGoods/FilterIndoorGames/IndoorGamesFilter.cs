...
{
    /// <summary>
    /// Defines the <see cref="IndoorGamesFilter" />.
    /// </summary>
    public class IndoorGamesFilter : BaseFilter, IIndoorGamesFilter, IIndoorGamesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IndoorGamesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="IndoorGamesCategory"/>.</param>
