...
{
    /// <summary>
    /// Defines the <see cref="PortableAudioAndVideoFilter" />.
    /// </summary>
    public class PortableAudioAndVideoFilter : BaseFilter, IPortableAudioAndVideoFilter, IPortableAudioAndVideoFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PortableAudioAndVideoFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="PortableAudioAndVideoCategory"/>.</param>
