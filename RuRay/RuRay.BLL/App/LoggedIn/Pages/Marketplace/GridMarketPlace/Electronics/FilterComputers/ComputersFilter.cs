...
{
    /// <summary>
    /// Defines the <see cref="ComputersFilter" />.
    /// </summary>
    public class ComputersFilter : BaseFilter, IComputersFilter, IComputersFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComputersFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="ComputersCategory"/>.</param>
