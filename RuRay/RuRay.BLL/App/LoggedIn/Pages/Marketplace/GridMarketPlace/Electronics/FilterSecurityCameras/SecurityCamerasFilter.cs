...
{
    /// <summary>
    /// Defines the <see cref="SecurityCamerasFilter" />.
    /// </summary>
    public class SecurityCamerasFilter : BaseFilter, ISecurityCamerasFilter, ISecurityCamerasFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecurityCamerasFilter"/> class.
        /// </summary>
        /// <param name="driver">The driver<see cref="RemoteWebDriver"/>.</param>
        public SecurityCamerasFilter(RemoteWebDriver driver) : base(driver)
        {
        }
