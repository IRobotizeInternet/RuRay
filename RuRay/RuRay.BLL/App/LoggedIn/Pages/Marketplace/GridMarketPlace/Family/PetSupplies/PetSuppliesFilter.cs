...
{
    /// <summary>
    /// Defines the <see cref="PetSuppliesFilter" />.
    /// </summary>
    public class PetSuppliesFilter : BaseFilter, IPetSuppliesFilter, IPetSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PetSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Brand.
        /// </summary>
        /// <param name="bodyStyle">The bodyStyle<see cref="BrandPetSupply"/>.</param>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="PetSuppliesCategory"/>.</param>
