...
{
    /// <summary>
    /// Defines the <see cref="ToysAndGamesFilter" />.
    /// </summary>
    public class ToysAndGamesFilter : BaseFilter, IToysAndGamesFilter, IToysAndGamesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToysAndGamesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="ToysAndGamesCategory"/>.</param>
