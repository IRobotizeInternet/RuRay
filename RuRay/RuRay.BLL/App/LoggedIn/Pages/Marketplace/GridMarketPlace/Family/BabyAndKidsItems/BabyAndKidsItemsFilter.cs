...
{
    /// <summary>
    /// Defines the <see cref="BabyAndKidsItemsFilter" />.
    /// </summary>
    public class BabyAndKidsItemsFilter : BaseFilter, IBabyAndKidsItemsFilter, IBabyAndKidsItemsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BabyAndKidsItemsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="BabyAndKidsItemsCategory"/>.</param>
