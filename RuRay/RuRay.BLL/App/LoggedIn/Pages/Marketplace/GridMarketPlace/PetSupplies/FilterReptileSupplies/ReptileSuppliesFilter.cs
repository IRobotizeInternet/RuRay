...
{
    /// <summary>
    /// Defines the <see cref="ReptileSuppliesFilter" />.
    /// </summary>
    public class ReptileSuppliesFilter : BaseFilter, IReptileSuppliesFilter, IReptileSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReptileSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="ReptileSuppliesCategory"/>.</param>
