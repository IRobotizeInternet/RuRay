...
{
    /// <summary>
    /// Defines the <see cref="BirdSuppliesFilter" />.
    /// </summary>
    public class BirdSuppliesFilter : BaseFilter, IBirdSuppliesFilter, IBirdSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BirdSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="BirdSuppliesCategory"/>.</param>
