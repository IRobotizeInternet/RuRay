...
{
    /// <summary>
    /// Defines the <see cref="DogSuppliesFilter" />.
    /// </summary>
    public class DogSuppliesFilter : BaseFilter, IDogSuppliesFilter, IDogSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DogSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="DogSuppliesCategory"/>.</param>
