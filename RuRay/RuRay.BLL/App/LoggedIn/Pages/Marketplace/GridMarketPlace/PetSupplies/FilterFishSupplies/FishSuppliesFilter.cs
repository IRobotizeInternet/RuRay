...
{
    /// <summary>
    /// Defines the <see cref="FishSuppliesFilter" />.
    /// </summary>
    public class FishSuppliesFilter : BaseFilter, IFishSuppliesFilter, IFishSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FishSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="FishSuppliesCategory"/>.</param>
