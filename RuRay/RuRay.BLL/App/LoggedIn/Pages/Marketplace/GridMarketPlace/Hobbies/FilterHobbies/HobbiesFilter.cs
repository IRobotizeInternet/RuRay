...
{
    /// <summary>
    /// Defines the <see cref="HobbiesFilter" />.
    /// </summary>
    public class HobbiesFilter : BaseFilter, IHobbiesFilter, IHobbiesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HobbiesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="HobbiesCategory"/>.</param>
