...
{
    /// <summary>
    /// Defines the <see cref="FishingGearFilter" />.
    /// </summary>
    public class FishingGearFilter : BaseFilter, IFishingGearFilter, IFishingGearFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FishingGearFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="FishingGearCategory"/>.</param>
