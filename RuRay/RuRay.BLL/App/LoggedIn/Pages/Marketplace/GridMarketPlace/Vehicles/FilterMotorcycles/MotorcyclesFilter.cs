...
{
    /// <summary>
    /// Defines the <see cref="MotorcyclesFilter" />.
    /// </summary>
    public class MotorcyclesFilter : BaseFilter, IMotorcyclesFilter, IMotorcyclesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MotorcyclesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="categoryType">The categoryType<see cref="MotorcycleCategory"/>.</param>
