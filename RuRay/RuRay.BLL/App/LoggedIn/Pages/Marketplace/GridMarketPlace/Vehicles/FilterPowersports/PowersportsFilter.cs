...
{
    /// <summary>
    /// Defines the <see cref="PowersportsFilter" />.
    /// </summary>
    public class PowersportsFilter : BaseFilter, IPowersportsFilter, IPowersportsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PowersportsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="categoryType">The categoryType<see cref="PowersportCategory"/>.</param>
