...
{
    /// <summary>
    /// Defines the <see cref="StorageAndOrganizationFilter" />.
    /// </summary>
    public class StorageAndOrganizationFilter : BaseFilter, IStorageAndOrganizationFilter, IStorageAndOrganizationFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageAndOrganizationFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="StorageAndOrganizationCategory"/>.</param>
