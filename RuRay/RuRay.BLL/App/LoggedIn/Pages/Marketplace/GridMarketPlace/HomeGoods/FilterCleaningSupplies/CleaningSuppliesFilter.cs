...
{
    /// <summary>
    /// Defines the <see cref="CleaningSuppliesFilter" />.
    /// </summary>
    public class CleaningSuppliesFilter : BaseFilter, ICleaningSuppliesFilter, ICleaningSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleaningSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="CleaningSuppliesCategory"/>.</param>
