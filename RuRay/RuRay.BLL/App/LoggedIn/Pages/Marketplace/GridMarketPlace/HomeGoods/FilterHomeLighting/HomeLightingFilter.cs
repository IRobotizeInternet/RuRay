...
{
    /// <summary>
    /// Defines the <see cref="HomeLightingFilter" />.
    /// </summary>
    public class HomeLightingFilter : BaseFilter, IHomeLightingFilter, IHomeLightingFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HomeLightingFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="HomeLightingCategory"/>.</param>
