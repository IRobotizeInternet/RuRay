...
{
    /// <summary>
    /// Defines the <see cref="BathProductsFilter" />.
    /// </summary>
    public class BathProductsFilter : BaseFilter, IBathProductsFilter, IBathProductsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BathProductsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="BathProductsCategory"/>.</param>
