...
{
    /// <summary>
    /// Defines the <see cref="HomeGoodsFilter" />.
    /// </summary>
    public class HomeGoodsFilter : BaseFilter, IHomeGoodsFilter, IHomeGoodsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HomeGoodsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="HomeDecorCategory"/>.</param>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="HomeGoodsCategory"/>.</param>
