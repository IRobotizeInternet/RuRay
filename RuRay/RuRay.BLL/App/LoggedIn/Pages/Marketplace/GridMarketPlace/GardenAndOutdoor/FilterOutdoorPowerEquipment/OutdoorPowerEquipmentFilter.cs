...
{
    /// <summary>
    /// Defines the <see cref="OutdoorPowerEquipmentFilter" />.
    /// </summary>
    public class OutdoorPowerEquipmentFilter : BaseFilter, IOutdoorPowerEquipmentFilter, IOutdoorPowerEquipmentFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutdoorPowerEquipmentFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="OutdoorPowerEquipmentCategory"/>.</param>
