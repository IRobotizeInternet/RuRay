...
{
    /// <summary>
    /// Defines the <see cref="PoolsAndSpasFilter" />.
    /// </summary>
    public class PoolsAndSpasFilter : BaseFilter, IPoolsAndSpasFilter, IPoolsAndSpasFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PoolsAndSpasFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="PoolsAndSpasCategory"/>.</param>
