...
{
    /// <summary>
    /// Defines the <see cref="OutdoorLightingFilter" />.
    /// </summary>
    public class OutdoorLightingFilter : BaseFilter, IOutdoorLightingFilter, IOutdoorLightingFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutdoorLightingFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="OutdoorLightingCategory"/>.</param>
