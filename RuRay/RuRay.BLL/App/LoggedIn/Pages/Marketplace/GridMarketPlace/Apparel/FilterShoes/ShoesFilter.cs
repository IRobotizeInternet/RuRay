...
{
    /// <summary>
    /// Defines the <see cref="ShoesFilter" />.
    /// </summary>
    public class ShoesFilter : BaseFilter, IShoesFilter, IShoesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShoesFilter"/> class.
        /// </summary>
        ...
        /// The Brand.
        /// </summary>
        /// <param name="bodyStyle">The bodyStyle<see cref="BrandShoe"/>.</param>
        ...
        /// The Category.
        /// </summary>
        /// <param name="categoryType">The categoryType<see cref="ShoesCategory"/>.</param>
