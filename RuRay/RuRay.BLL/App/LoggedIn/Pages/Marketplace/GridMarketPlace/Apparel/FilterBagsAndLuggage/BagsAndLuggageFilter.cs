...
{
    /// <summary>
    /// Defines the <see cref="BagsAndLuggageFilter" />.
    /// </summary>
    public class BagsAndLuggageFilter : BaseFilter, IBagsAndLuggageFilter, IBagsAndLuggageFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BagsAndLuggageFilter"/> class.
        /// </summary>
        ...
        /// The Brand.
        /// </summary>
        /// <param name="bodyStyle">The bodyStyle<see cref="BrandBagsAndLuggage"/>.</param>
        ...
        /// The Category.
        /// </summary>
        /// <param name="categoryType">The categoryType<see cref="BagsAndLuggageCategory"/>.</param>
