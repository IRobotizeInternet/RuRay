...
{
    /// <summary>
    /// Defines the <see cref="SaxophonesFilter" />.
    /// </summary>
    public class SaxophonesFilter : BaseFilter, ISaxophonesFilter, ISaxophonesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SaxophonesFilter"/> class.
        /// </summary>
        ...
        /// Gets the FilterBy.
        /// </summary>
        public ISaxophonesFilterOptions FilterBy => throw new NotImplementedException();
