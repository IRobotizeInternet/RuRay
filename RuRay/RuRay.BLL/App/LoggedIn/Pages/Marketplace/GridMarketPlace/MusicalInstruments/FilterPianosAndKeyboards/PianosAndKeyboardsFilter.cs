...
{
    /// <summary>
    /// Defines the <see cref="PianosAndKeyboardsFilter" />.
    /// </summary>
    public class PianosAndKeyboardsFilter : BaseFilter, IPianosAndKeyboardsFilter, IPianosAndKeyboardsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PianosAndKeyboardsFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="PianosAndKeyboardsCategory"/>.</param>
