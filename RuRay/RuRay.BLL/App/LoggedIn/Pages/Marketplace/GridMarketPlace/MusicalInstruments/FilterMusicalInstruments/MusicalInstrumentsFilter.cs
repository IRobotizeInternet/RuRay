...
{
    /// <summary>
    /// Defines the <see cref="MusicalInstrumentsFilter" />.
    /// </summary>
    public class MusicalInstrumentsFilter : BaseFilter, IMusicalInstrumentsFilter, IMusicalInstrumentsFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MusicalInstrumentsFilter"/> class.
        /// </summary>
        /// <param name="driver">The driver<see cref="RemoteWebDriver"/>.</param>
        public MusicalInstrumentsFilter(RemoteWebDriver driver) : base(driver)
        {
        }
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="GuitarsAndBassesCategory"/>.</param>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="MusicalInstrumentsCategory"/>.</param>
