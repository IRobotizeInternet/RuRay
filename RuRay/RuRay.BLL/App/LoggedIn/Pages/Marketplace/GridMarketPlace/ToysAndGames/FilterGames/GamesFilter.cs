...
{
    /// <summary>
    /// Defines the <see cref="GamesFilter" />.
    /// </summary>
    public class GamesFilter : BaseFilter, IGamesFilter, IGamesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GamesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="GamesCategory"/>.</param>
