...
{
    /// <summary>
    /// Defines the <see cref="ToyVehiclesFilter" />.
    /// </summary>
    public class ToyVehiclesFilter : BaseFilter, IToyVehiclesFilter, IToyVehiclesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ToyVehiclesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="ToyVehiclesCategory"/>.</param>
