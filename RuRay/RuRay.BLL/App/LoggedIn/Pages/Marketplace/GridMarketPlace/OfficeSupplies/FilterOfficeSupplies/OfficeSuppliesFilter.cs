...
{
    /// <summary>
    /// Defines the <see cref="OfficeSuppliesFilter" />.
    /// </summary>
    public class OfficeSuppliesFilter : BaseFilter, IOfficeSuppliesFilter, IOfficeSuppliesFilterOptions
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficeSuppliesFilter"/> class.
        /// </summary>
        ...
        /// The Category.
        /// </summary>
        /// <param name="category">The category<see cref="OfficeSuppliesCategory"/>.</param>
